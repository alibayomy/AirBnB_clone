...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_two_users_unique_ids(self):
        us11 = User()
        us2 = User()
        self.assertNotEqual(us11.id, us2.id)

    def test_two_users_different_created_at(self):
        us11 = User()
        sleep(0.05)
        us2 = User()
        self.assertLess(us11.created_at, us2.created_at)

    def test_two_users_different_updated_at(self):
        us11 = User()
        sleep(0.05)
        us2 = User()
        self.assertLess(us11.updated_at, us2.updated_at)
...
class TestUser_save(unittest.TestCase):
    """Unittests for testing save method of the inhirted
             class."""
...
class TestUser_to_dict(unittest.TestCase):
    """Unittests for testing to_dict method of the User inhirted
            class."""
