...
class TestPlace_instantiation(unittest.TestCase):
    """Unittests for testing instantiation of the Place
        inherited class."""
    ...
    def test_str_representation(self):
        ...
        pl = Place()
        pl.id = "123456"
        pl.created_at = pl.updated_at = td
        plstr = pl.__str__()
        self.assertIn("[Place] (123456)", plstr)
        self.assertIn("'id': '123456'", plstr)
        self.assertIn("'created_at': " + td_repr, plstr)
        self.assertIn("'updated_at': " + td_repr, plstr)
    ...
    def test_instantiation_with_kwargs(self):
        td = datetime.today()
        td_iso = td.isoformat()
        pl = Place(id="345", created_at=td_iso, updated_at=td_iso)
        self.assertEqual(pl.id, "345")
        self.assertEqual(pl.created_at, td)
        self.assertEqual(pl.updated_at, td)
...
class TestPlace_save(unittest.TestCase):
    """Unittests for testing save method of the Place inhierted
             class."""
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_output(self):
        ...
        tdict = {
            'id': '123456',
            '__class__': 'Place',
            'created_at': td.isoformat(),
            'updated_at': td.isoformat(),
        }
