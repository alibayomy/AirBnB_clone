#!/usr/bin/python3
"""Module unittesting for models/city.py.
...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        city = City()
        city.id = "123456"
        city.created_at = city.updated_at = datime
        cystr = city.__str__()
        self.assertIn("[City] (123456)", cystr)
        self.assertIn("'id': '123456'", cystr)
        self.assertIn("'created_at': " + datime_repr, cystr)
        self.assertIn("'updated_at': " + datime_repr, cystr)
